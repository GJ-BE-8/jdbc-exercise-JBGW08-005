...
public class ClubRepositoryImpl implements ClubRepository {
    ...
    public Optional<Club> findByClubId(Connection connection, String clubId) {
        ...
        try(PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            return Optional.of(new Club(rs.getString("club_id"), rs.getString("club_name"), rs.getTimestamp("club_created_at").toLocalDateTime()));
    ...
    public int save(Connection connection, Club club) {
        ...
        try(PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            ps.setString(3, club.getClubCreatedAt().toString());
